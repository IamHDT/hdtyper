...
import {ITermState, ITermGroup, HdtyperState, HdtyperDispatch, HdtyperActions} from '../hdtyper';
import {Immutable} from 'seamless-immutable';

function requestSplit(direction: 'VERTICAL' | 'HORIZONTAL') {
  return (activeUid: string) => (dispatch: HdtyperDispatch, getState: () => HdtyperState): void => {
    dispatch({
...
export function resizeTermGroup(uid: string, sizes: number[]): HdtyperActions {
  return {
    uid,
