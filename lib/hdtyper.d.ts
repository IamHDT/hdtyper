...
export type hdtyperPlugin = {
  getTabProps: any;
  getTabsProps: any;
  getTermGroupProps: any;
  getTermProps: any;
  mapHeaderDispatch: any;
  mapHdtyperDispatch: any;
  mapHdtyperTermDispatch: any;
  mapNotificationsDispatch: any;
  mapTermsDispatch: any;
  mapHeaderState: any;
  mapHdtyperState: any;
  mapHdtyperTermState: any;
...
export type HdtyperDispatch = ReturnType<typeof configureStore>['dispatch'];
...
import {HdtyperConnectedProps} from './containers/hdtyper';
export type HdtyperProps = HdtyperConnectedProps & extensionProps;
