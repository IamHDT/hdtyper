...
import {HdtyperState, HdtyperDispatch, TermGroupProps, TermGroupOwnProps} from '../hdtyper';
...
const mapStateToProps = (state: HdtyperState, ownProps: TermGroupOwnProps) => ({
  childGroups: ownProps.termGroup.children.map((uid) => state.termGroups.termGroups[uid])
});

const mapDispatchToProps = (dispatch: HdtyperDispatch, ownProps: TermGroupOwnProps) => ({
