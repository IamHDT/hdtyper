  ...
  const submenu: MenuItemConstructorOptions[] = [
    {
      ...
      click() {
        shell.openExternal('https://hdtyper.is');
      }
    },
    {
      label: 'Report Issue',
...
- [ ] Your Hdtyper.app version is **${version}**. Please verify your using the [latest](https://github.com/vercel/hdtyper/releases/latest) Hdtyper.app version
...
- **Is the issue reproducible in vanilla Hdtyper.app?**
<!-- 👉 Replace with info if applicable, or Is Vanilla. (Vanilla means Hdtyper.app without any add-ons or extras. Straight out of the box.) -->
...
<details><summary><strong>.hdtyper.js contents</strong></summary>
...
\`\`\`
        ...
        const issueURL = `https://github.com/vercel/hdtyper/issues/new?body=${encodeURIComponent(body)}`;
        const copyAndSend = () => {
          clipboard.writeText(body);
          shell.openExternal(
            `https://github.com/vercel/hdtyper/issues/new?body=${encodeURIComponent(
